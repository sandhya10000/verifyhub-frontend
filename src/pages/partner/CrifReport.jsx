...
const CrifReport = () => {
  ...
  // API se baad mein dynamic values aayengi
  ...
  const handleGenerateReport = async () => {
    try {
      ...
      // Example:
      //
      const response = await creditAPI.generateCrifReport({
      ...
      console.log("CRIF Report Request:", {
        firstName: formData.firstName,
        lastName: formData.lastName,
        mobile: formData.mobile,
        pan: formData.pan,
      ...
      // PDF/report download yahan handle karein.
    } catch (err) {
      console.error("CRIF Report Error:", err);

      setError(
        err?.response?.data?.message ||
          "Unable to generate CRIF report. Please try again.",
      );
    } finally {
      setLoading(false);
    }
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Get your CRIF credit report instantly – secure & hassle-free
          </Typography>
        </Box>
          ...
          >
            ...
            >
              ...
              <Box mb={3}>
                ...
                >
                  Enter customer details to generate the CRIF credit report.
                </Typography>
              </Box>
              ...
              >
                {loading ? "Generating CRIF Report..." : "Download CRIF Report"}
              </Button>
